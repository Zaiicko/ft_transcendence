...
// Icônes filaires (trait 1.6, viewBox 24, currentColor) dans le style TiMN du
// reste du site — une par famille de succès. Remplacent les emoji.
...
const PATHS: Record<AchievementFamily, ReactNode> = {
  // Drapeau d'arrivée — jeux terminés
  completions: (
    <>
      <path d="M5 21V4" />
  ...
  // Maillon de chaîne — comptes liés
  linked: (
    <>
  ...
  // Pouce en bas — critique sévère (note 0)
  harsh: (
    <>
      <path d="M17 2v12" />
