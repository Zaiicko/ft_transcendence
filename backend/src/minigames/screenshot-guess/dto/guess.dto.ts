...
import { ScreenshotGuessRoundMode } from '../screenshot-guess.types';
...
// ScreenshotGuessService.guessLocal): only LOCAL play needs to say which mode
...
export class GuessScreenshotGuessDto {
  @IsOptional()
  @IsInt()
  catalogId?: number;
