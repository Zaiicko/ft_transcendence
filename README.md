...
- **Platform integrations** — Steam (OpenID login/linking, library, achievements, review-score sync), PlayStation (PSN ID linking, games + trophies + friends via psn-api), Xbox (OpenXBL linking + library + gamerscore), unified "My libraries" page, hourly background re-sync cron, real 100% completion detection & dates
